  ...
  return (
    <div className='max-w-[1400px] h-[500px] bg-blue-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4'>
      <div className='lg:top-20 relative lg:col-span-1 col-span-2'>
        ...
        <p className='pt-4'>
        Showcases the work of interior designers from around the world. The website features a wide range of projects, from residential homes to commercial spaces. The designs are all beautifully photographed and the website is easy to navigate.
        </p>
      </div>
